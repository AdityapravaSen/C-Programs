# This is a TO-DO LIST Project in c

### Instructions to Run the program:-
1. Download and extract the project
2. open terminaland go to the *project directory*
3. compile the project using the command :- *gcc todo.c*
4. **./todo help** to see instructions
